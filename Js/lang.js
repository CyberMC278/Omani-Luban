const translations = {
    ar: {
        "page_title": "اللبان العماني - أصالة وتراث",
        "nav_logo": "اللبان العماني",
        "nav_home": "الرئيسية",
        "nav_locations": "أماكن التواجد",
        ...
        "loc_dhofar_title": "محافظة ظفار",
        "loc_dhofar_desc": "الموطن الأصلي لأجود أنواع اللبان (الحوجري)، حيث تتوفر البيئة المناخية المثالية لنمو الأشجار.",
        "loc_dawkah_title": "وادي دوكة",
        "loc_dawkah_desc": "موقع مسجل ضمن قائمة التراث العالمي لليونسكو، ويعد محمية طبيعية ومزاراً تاريخياً لأشجار اللبان.",
        "ext_title": "طريقة استخلاص اللبان",
        "ext_step1_title": "التوقيع (التجريح):",
        "ext_step1_desc": "يتم إحداث شقوق في قشرة جذع الشجرة باستخدام أداة تقليدية حادة تسمى \"المنقَف\".",
        "ext_step2_title": "الانتظار والإفراز:",
        "ext_step2_desc": "تُترك الشجرة لعدة أيام حتى تفرز المادة الصمغية البيضاء وتتجمد على الجذع.",
        "ext_step3_title": "الجني الأولي:",
        "ext_step3_desc": "تُجمع الإفرازات الأولى وتكون عادة أقل جودة لتنظيف الشجرة.",
        "ext_step4_title": "الجني الأساسي:",
        "ext_step4_desc": "يتم تجريح الشجرة مرة أخرى للحصول على اللبان النقي وعالي الجودة، وتتكرر العملية عدة مرات في الموسم.",
        "ext_step5_title": "الفرز والتجفيف:",
        "ext_step5_desc": "يُنقل اللبان إلى أماكن مظللة ليجف تماماً، ثم يُفرز يدوياً حسب الحجم واللون والجودة.",
        "use_title": "استعمالات اللبان",
        "use_1": "صناعة العطور الفاخرة والبخور ذو الرائحة الزكية.",
        "use_2": "يستخدم في المجالات الطبية والعلاجات التقليدية.",
        "use_3": "يدخل في صناعة مستحضرات التجميل والعناية بالبشرة.",
        "use_4": "تعطير وتبخير المنازل والمجالس والمساجد.",
        "ben_title": "الفوائد الصحية",
        "ben_1": "يعمل كمطهر طبيعي للجسم ويقوي جهاز المناعة.",
    ...
    en: {
        ...
        "home": "Omani frankincense",
        "home_desc": "The white gold, the finest frankincense in the world. A symbol of Omani authenticity and a heritage extending over millennia.",
        ...
        "ext_step2_title": "Waiting and Secreting:",
        "ext_step2_desc": "The tree is left for several days to secrete the white resin, which hardens on the trunk.",
        ...
        "use_4": "Scenting and fumigating homes, majlises, and mosques.",
        "ben_title": "Health Benefits",
        "ben_1": "Acts as a natural body purifier and strengthens the immune system.",
